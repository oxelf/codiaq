...
class Either2<T1, T2> implements ToJsonable {
  ...
  const Either2.t1(T1 this._t1) : _t2 = null, _which = 1;

  const Either2.t2(T2 this._t2) : _t1 = null, _which = 2;
...
class Either3<T1, T2, T3> implements ToJsonable {
  ...
  Either3.t1(this._t1) : _t2 = null, _t3 = null, _which = 1;

  Either3.t2(this._t2) : _t1 = null, _t3 = null, _which = 2;

  Either3.t3(this._t3) : _t1 = null, _t2 = null, _which = 3;
  ...
  @override
  String toString() =>
      map((t) => t.toString(), (t) => t.toString(), (t) => t.toString());
...
class Either4<T1, T2, T3, T4> implements ToJsonable {
  ...
  Either4.t1(this._t1) : _t2 = null, _t3 = null, _t4 = null, _which = 1;

  Either4.t2(this._t2) : _t1 = null, _t3 = null, _t4 = null, _which = 2;

  Either4.t3(this._t3) : _t1 = null, _t2 = null, _t4 = null, _which = 3;

  Either4.t4(this._t4) : _t1 = null, _t2 = null, _t3 = null, _which = 4;
