// GENERATED CODE - EDITED BY HAND FOR REFACTORING

// GENERATED CODE - EDITED BY HAND FOR REFACTORING

// Your own project's imports would go here.
// I'm using placeholder names based on your provided file.
...
class Highlighter {
  ...
  Result _parse(
    ...
    dynamic _keywordMatch(Mode mode, RegExpMatch match) {
      var match_str =
          langMode.case_insensitive == true
              ? match[0]!.toLowerCase()
              : match[0];
